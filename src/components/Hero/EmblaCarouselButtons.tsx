...
export const DotButton = ({ selected, onClick }: ButtonSProps) => (
  <button
...
export const PrevButton = ({ enabled, onClick }: ButtonProps) => (
  <button
    className={[styles.embla__button, styles.embla__button__prev].join(' ')}
    onClick={onClick}
    disabled={!enabled}
  >
...
export const NextButton = ({ enabled, onClick }: ButtonProps) => (
  <button
    className={[styles.embla__button, styles.embla__button__next].join(' ')}
    onClick={onClick}
    disabled={!enabled}
  >
